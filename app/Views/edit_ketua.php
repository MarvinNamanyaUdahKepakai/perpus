        ...
        <form class="form-horizontal form-label-left" novalidate  action="<?= base_url('/home/aksi_edit_ketua/?')?>"method="post">
 ...
 <div class="item form-group">
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_ketua">Nama Ketua<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nama_ketua" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nama_ketua" placeholder="Isi nama petugas" required="required" type="text" value="<?php echo $jojo->nama_ketua?>">
            </div>
          </div>
