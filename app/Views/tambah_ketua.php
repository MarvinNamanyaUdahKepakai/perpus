  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        ...
        <form class="form-horizontal form-label-left" novalidate action="<?= base_url('/home/aksi_tambah_ketua/?')?>"method="post" enctype="multipart/form-data">
         ...
         <div class="item form-group">
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_ketua">Nama Ketua RT/RW<span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="nama_ketua" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="nama_ketua" placeholder="Isi nama nama_ketua" required="required" type="text">
            </div>
          </div>
